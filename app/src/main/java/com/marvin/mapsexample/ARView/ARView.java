...
import com.marvin.mapsexample.ARView.Utils.Compatibility;
    ...
    public void surfaceChanged(SurfaceHolder holder, int format, int w, int h) {
        try {
            ...
            try {
                ...
                supportedSizes = com.marvin.mapsexample.ARView.Utils.Compatibility.getSupportedPreviewSizes(parameters);
